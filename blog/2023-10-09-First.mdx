...
title: First
authors: [jonas]
description: Bienvenue sur le blog de TiBillet ! Nous allons essayer de vous expliquer comment nous avons fait, pourquoi nous avons fait comme ça, et comment vous pouvez faire pareil chez vous.
tags: [blog, tibillet, histoire, origine]
---

# First !

Tout l'équipe de TiBillet vous souhaite la bienvenue sur notre blog !
...
Et bien tout ceci, c'est ce que l'on va tenter de vous raconter dans ce blog. Nous allons essayer de vous expliquer comment nous avons fait, pourquoi nous avons fait comme ça, et comment vous pouvez faire pareil chez vous.
